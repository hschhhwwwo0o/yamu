      ...
      <DefaultWrapperLayout>
        <div className="px-mobile-padding md:px-laptop-padding pb-10">
          ...
          <Text className="mt-6">
            ...
            requirements, quality attributes were formulated; a data dictionary
            and a dictionary of terms were compiled.
          </Text>
          <Text className="mt-6">
            A unique ID is created for each requirement. At the stage the code
            writing phase, the ID of the requirement to be implemented is marked
            in the comment; this makes it easy to find the implementation of a
            particular requirement in the code base. In the book «Development of
            software requirements» by Carl Vigers & Jay Beatty, this approach is
            called requirements tracking.
          </Text>
          <H2 className="mt-10">2. Design development.</H2>
          <Text className="mt-6">
            The design of the application was developed in Figma/Photoshop. The
            design was developed in accordance with the previously developed
          ...
          <Text className="mt-6">
            ...
            through the modules. Thus, the application (in this case, the NextJS
            framework) is responsible only for displaying the UI, while the
            modules contain all the business logic. Each module performs only
            one task and should not interact with other modules in any way.
          </Text>
          <Text className="mt-6">
            ...
            they can be used independently of the framework; this makes it very
            easy to migrate from ReactJS to VueJS, for example.
          </Text>
