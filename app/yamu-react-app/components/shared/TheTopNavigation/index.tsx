...
export function TheTopNavigation(): ReactNode {
  ...
  return (
    <Fragment>
      ...
      <nav className="bg-black w-full h-[57px] z-50 fixed left-0 top-0 dark:border-solid dark:border-b-[1px] dark:border-b-dark-default-border flex flex-row justify-between items-center px-mobile-padding">
        {
